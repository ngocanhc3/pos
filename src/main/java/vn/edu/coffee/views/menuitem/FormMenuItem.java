 ...
 * @author Ngoc Anh
 */
public class FormMenuItem extends javax.swing.JDialog {

    
    public MyActionEvent<MenuItem> addEvent;
    private MenuItem item;
    /**
     * Creates new form FormMenuItem
     */
    public FormMenuItem(java.awt.Frame parent, MenuItem item) {
        super(parent, true);
        initComponents();
    ...
    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        ...
        item.setStatus(ckActive.isSelected());
        if (addEvent != null) {
            addEvent.onAction(item);
            onClose();
        }
